export default function Footer() {
  return (
    <div className="footerContainer">
      <div className="bg-gradient-to-r from-black to-[#017434] p-14 md:flex md:justify-between">
        <div className="left">
        ...
        <div className="right text-wrap text-white md:w-1/4">
          <h2 className=" text-2xl my-4">Trippy Headquarters </h2>
          <p>
      ...
      <ul className="flex gap-10 text-white bg-gradient-to-r from-black to-[#017434] justify-end items-center pb-5 pr-16">
        <li>About Us</li>
        <li>Destinations</li>
