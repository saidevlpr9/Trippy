      ...
      <div className="bg-black h-screen">
        ...
        <div className="flex justify-center items-center">
          <div className="px-44">
            ...
            <div className="my-10">
              <h2 className="text-white  text-2xl text-pretty"> Our Mission</h2>
              <p className="text-white text-lg text-pretty">
            ...
            <div className="my-10">
              <h2 className="text-white  text-2xl text-pretty">
                {" "}
                Why Choose Trippy?
              </h2>
              <p className="text-white text-lg text-pretty">
            ...
            <div className="my-10">
              <h2 className="text-white  text-2xl text-pretty">Join Us</h2>
              <p className="text-white text-lg text-pretty">
