...
const cards = [
  {
    ...
    description: "Experience the tranquility of Kerala’s backwaters with a stay on a traditional houseboat.",
    ...
    content: () => (
      <>
        ...
        <p>Price: ₹15,000</p>
        <p>Highlights: Traditional houseboat ride, Scenic landscapes, Authentic Kerala cuisine.</p>
      </>
    ),
  },
  {
    title: "Himalayan Adventure in Himachal Pradesh",
    description: "An exhilarating trek through Himachal’s stunning mountain trails.",
  ...
  },
  {
    ...
    description: "Explore the Thar Desert with camel rides, cultural performances, and luxury desert camps.",
  ...
  },
  {
    ...
    description: "Discover Varanasi’s spirituality, visiting ancient ghats and temples.",
